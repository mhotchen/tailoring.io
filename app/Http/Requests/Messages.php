...
final class Messages
{
    ...
    public const GENERIC_DISTINCT = 'fields.generic.distinct';
    public const GENERIC_INTEGER  = 'fields.generic.integer';
    ...
    public const GENERIC_INVALID  = 'fields.generic.invalid';
